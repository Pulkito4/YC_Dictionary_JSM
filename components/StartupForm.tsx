...
const StartupForm = () => {
	...
	const [errors, setIsErrors] = useState<Record<string, string>>({});
	...
	const handleFormSubmit = async (prevState: any, formData: FormData) => {
		...
		try {
			...
			if (result.status == "SUCCESS") {
				toast({
					title: "Success",
					description: "Your startup  has been pitched successfully!",
				});
			...
			if (error instanceof z.ZodError) {
				...
				setIsErrors(fieldErrors as unknown as Record<string, string>);
